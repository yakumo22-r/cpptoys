...
#else
#pragma error "C++17 or later is required for (symbol_loader.hpp)."
#endif
...
inline void* get_symbol_addr(libh_t libhandle, const char* symbol) { return (void*)GetProcAddress(libhandle, symbol); }
