...
#ifndef Print
#define Print(...) (fmt::print("[INFO] {}{}\n", fmt::format(__VA_ARGS__), NONE))
#endif

#ifndef Warn
#define Warn(...) (fmt::print("{}[WARN] {}{}\n", YELLOW, fmt::format(__VA_ARGS__), NONE))
#endif

#ifndef Error
#define Error(...) (fmt::print("{}[Error] {}{}\n", RED, fmt::format(__VA_ARGS__), NONE))
#endif
...
checkFeatures(const char *label, const bool validationEnabled, const bool extensions,
    ...
    *enabledCount = 0;
    for ( uint32_t i = 0; i < requestedCount; i++ )
    {
        ...
        Print( "{}({}) {} {}", label, i, requested[i].name, result );
    }
